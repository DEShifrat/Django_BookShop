# Generated by Django 4.1.2 on 2022-12-07 22:23
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('order', models.OneToOneField(on_delete=django.db.models.deletion.PROTECT, primary_key=True, serialize=False, to='library.order', verbose_name='Заказ')),
            ],
            options={
                'verbose_name': 'Чек',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('books', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to='library.book', verbose_name='Книга')),
                ('order', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to='library.order', verbose_name='Заказ')),
            ],
            options={
                'verbose_name': 'Позиция',
                'verbose_name_plural': 'Позиции',
                'ordering': ['books', 'order', 'price'],
            },
        ),
        migrations.AddField(
            model_name='order',
        ...
        migrations.AddField(
            model_name='book',
            name='supplier',
            field=models.ForeignKey(null=True, on_delete=django.db.models.deletion.PROTECT, to='library.supplier', verbose_name='Автор'),
        ),
    ]
